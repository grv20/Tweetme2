...
class ProfileTestCase(TestCase):
    ...
    def test_following(self):
        ...
        qs = second_user_following_whom.filter(user=first) # from a user, checked other user is being followed
        first_user_following_no_one = first.following.all() # check new user has no following
